...
function NeverLose:CreateWindow(Config)
	...
	function Window:AddTab(Config)
		...
		function Tab:AddPage(Config)
			...
			BtnFrame.AutomaticSize      = Enum.AutomaticSize.X;
			BtnFrame.Size               = UDim2.new(0, 0, 0, 22);
			...
			-- padding inside pill via UIPadding
			...
			BtnLine.Position          = UDim2.new(0.5, 0, 1, 2);
			BtnLine.Size              = UDim2.new(0.7, 0, 0, 2);
			BtnLine.ZIndex            = 12;
			...
			-- click handler
			NeverLose:CreateInput(BtnFrame, LPH_NO_VIRTUALIZE(function()
				SetActivePage(pageIdx);
			end));

			-- hover glow
			local btnInput = NeverLose:CreateInput(BtnFrame);
