...
function NeverLose:CreateWindow(Config)
	...
	function Window:AddTab(Config)
		...
		local function SetActivePage(idx)
			...
			for i, pg in next, Tab.Pages do
				...
				if isActive then
					...
					NeverLose.PlayAnimate(pg.BtnLine, SlowyTween, {
						BackgroundTransparency = 0,
						BackgroundColor3 = NeverLose.AccentColor
					});
				else
		...
		function Tab:AddPage(Config)
			...
			local BtnLineCorner = Instance.new("UICorner");
			...
			-- Accent underline at bottom of pill
			BtnLine.Name              = NeverLose.RandomString();
			BtnLine.Parent            = BtnFrame;
			BtnLine.AnchorPoint       = Vector2.new(0.5, 1);
			BtnLine.BackgroundColor3  = NeverLose.AccentColor;
			BtnLine.BackgroundTransparency = 1;
			BtnLine.BorderSizePixel   = 0;
			BtnLine.Position          = UDim2.new(0.5, 0, 1, 1);
			BtnLine.Size              = UDim2.new(0.8, 0, 0, 2);
			BtnLine.ZIndex            = 12;
			BtnLineCorner.CornerRadius = UDim.new(1, 0);
			BtnLineCorner.Parent       = BtnLine;
